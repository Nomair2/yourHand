...
class _ChatScreenState extends State<ChatScreen> {
  ChatProviderController controller = Get.find<ChatProviderController>();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ZoomIn(
          ...
          child: Text(widget.chat.nameMother,
                  ...
                  return Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        //   message.timestamp = Timestamp.now(); // Set a default timestamp
                        // }
                        return Padding(
...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      return Row(
          textDirection: message.sender == 'serviceProvider'
              ? TextDirection.rtl
              : TextDirection.ltr,
          children: [
            // Container(
            ...
            //   decoration: BoxDecoration(
            //     color: message.sender == 'serviceProvider'
            //         ? ThemeColor.primary
            //         : Colors.grey[200],
